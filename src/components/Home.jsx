...
function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex gap-2 w-[250px] rounded-full  bg-blue-800/30  lg:ml-1 md:ml-55">
        ...
        <div className="md:flex-row lg:gap-2 pl-4  lg:mt-6  lg:mb-20 flex  flex-col gap-4 justify-center mt-12">
          <button className=" w-[380px] md:w-[180px]   lg:ml-[-20px] bg-blue-600/100 hover:bg-blue-800/100  h-[45px] font-sans capitalize rounded-2xl lg:mt-6">
            <a href="#projects">veiw my projects</a>
          </button>
          <button className="w-[380px] md:w-[170px]   border-[1px] border-gray-600 bg-gray-600/50 hover:bg-gray-600/20 h-[45px] font-sans capitalize rounded-2xl lg:mt-6">
      ...
      <div
        id="home-imgs"
        className="relative md:mt-28 mt-18 md:mr-12 lg:ml-[50px]"
      >
        <div className="capitalize  flex gap-3 absolute  ml-75 md:ml-[550px] lg:ml-90 w-[120px] bg-blue-700/20 text-center rounded-2xl mt-[-10px] h-[35px] pt-1 ">
          <i className="fa-solid fa-circle text-[6px] text-blue-600/100 pt-3 ml-3 "></i>{" "}
          react dev
        </div>
        <img
          src={carbonimg}
          alt="img"
          className="h-[300px] w-[350px] lg:ml-18  ml-4 md:ml-66  mb-12 "
        />

        <div className="capitalize absolute lg:ml-6 ml-[-25px] md:ml-[220px] w-[100px] bg-blue-700/20 text-center rounded-2xl mt-[-70px]">
          ui / ux
        </div>
      </div>
    </div>
